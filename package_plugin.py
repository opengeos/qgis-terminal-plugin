...
- Root folder renamed from 'qgis_terminal' to the target plugin name
...
def package_plugin(
    ...
    Args:
        source_dir: Path to the qgis_terminal directory
        output_path: Optional path for the output zip file
        target_name: Name for the root folder in the zip (default: 'qgis_terminal')
...
def main():
    ...
    parser.add_argument(
        ...
        type=Path,
        default=None,
        help="Output path for the zip file (default: qgis_terminal-{version}.zip in the same folder as this script)",
    )
    parser.add_argument(
        "--source",
        "-s",
        type=Path,
        default=None,
        help="Source directory (default: qgis_terminal in the same folder as this script)",
    )
    parser.add_argument(
        "--name",
        "-n",
        type=str,
        default="qgis_terminal",
        help="Target plugin name for the zip root folder (default: qgis_terminal)",
    )
    parser.add_argument(
        "--no-version",
        action="store_true",
    ...
    source_dir = args.source if args.source else script_dir / "qgis_terminal"

#!/bin/bash
# Installation script for QGIS Terminal
#
# Usage:
...
while [[ $# -gt 0 ]]; do
    case $1 in
        ...
        --help|-h)
            ...
            echo "  --name, -n NAME   Plugin folder name (default: qgis_terminal)"
...
if [[ "$OSTYPE" == "linux-gnu"* ]]; then
    ...
    echo "Please manually copy the qgis_terminal folder to your QGIS plugins directory."
    exit 1
fi
